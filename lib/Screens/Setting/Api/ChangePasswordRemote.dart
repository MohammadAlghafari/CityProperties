...
class  ChangePasswordRemoteDataSourceImpl extends ChangePasswordRemoteDataSource {
  ...
  ChangePasswordRemoteDataSourceImpl({required this.dio, required this.networkInfo});
  ...
  Future<Either<String, ChangePasswordModel>> changePassword(
    ...
    if (await networkInfo.hasConnection) {
      try {
        String? userName=Preferences.preferences!.getString(KeyConstants.keyUserName);
